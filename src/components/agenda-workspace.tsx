...
export function AgendaWorkspace({ clinicName, userName, selectedDate, today, appointments, professionals, patients, chairs, message, messageTone }: { clinicName: string; userName: string; selectedDate: string; today: string; appointments: Appointment[]; professionals: Professional[]; patients: Patient[]; chairs: Chair[]; message: string | null; messageTone: "success" | "error" }) {
